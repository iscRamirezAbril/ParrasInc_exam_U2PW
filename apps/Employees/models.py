...
class Employee(models.Model):
    ...
    empBirthDate:       models.DateField(null = False)
    ...
    empPassword:        models.CharField(max_length=50, null = False)
    empLastLogin:       models.DateTimeField(auto_now=True, null = False)
